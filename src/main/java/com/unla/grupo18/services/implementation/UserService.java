...
public class UserService implements UserDetailsService {
	...
	public List<com.unla.grupo18.entities.User> getAllUsers() {
		return userRepository.findAll();
	}
	
	public com.unla.grupo18.entities.User getUserById(int userId) {
		Optional<com.unla.grupo18.entities.User> user = userRepository.findById(userId);
